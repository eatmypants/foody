 ...
 */
public class FrenchRestaurants extends ListActivity {
	/**
	 ...
	 */
	private static String url_all_restaurants = "http://foodyapp.890m.com//android_connect/get_french_restaurants.php";
	/**
	 * JSON Node names.
	 */
	...
	class LoadAllrestaurants extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(FrenchRestaurants.this);
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ListAdapter adapter = new SimpleAdapter(
							FrenchRestaurants.this, restaurantsList,
